...
defmodule CalendarTest do
  ...
  test :valid? do
    t = %DateTime{year: 2001, month: 2, day: 28, hour: 0, minute: 0, second: 0, nanosecond: 0, offset: { 0, 0 }}
    assert Calendar.valid?(t)

    t = %DateTime{year: 2001, month: 2, day: 29, hour: 0, minute: 0, second: 0, nanosecond: 0, offset: { 0, 0 }}
  ...
  test :plus do
    t = %DateTime{year: 2000, month: 2, day: 28, hour: 23, minute: 0, second: 0, nanosecond: 1, offset: { 1, 1 }}
  ...
  test :minus do
    t = %DateTime{year: 2000, month: 3, day: 1, hour: 0, minute: 0, second: 0, nanosecond: 1, offset: { 1, 1 }}
  ...
  test :change_offset do
    t = %DateTime{year: 2000, month: 1, day: 1, hour: 0, minute: 0, second: 0, nanosecond: 0, offset: { 0, 0 }}
  ...
  test :equal? do
    t1 = %DateTime{year: 2000, month: 1, day: 1, hour: 0, minute: 0, second: 0, nanosecond: 0, offset: { 0, 0 }}
    t2 = %DateTime{year: 2000, month: 1, day: 1, hour: 0, minute: 0, second: 0, nanosecond: 0, offset: { 0, 0 }}
    Calendar.equal?(t1, t2)
  end

  test :is_after? do
    t1 = %DateTime{year: 2000, month: 1, day: 1, hour: 0, minute: 0, second: 0, nanosecond: 0, offset: { 0, 0 }}
    t2 = %DateTime{year: 2000, month: 1, day: 1, hour: 0, minute: 1, second: 0, nanosecond: 0, offset: { 0, 0 }}
    refute Calendar.is_after?(t1, t2)
    assert Calendar.is_after?(t2, t1)

    t1 = %DateTime{year: 2000, month: 1, day: 1, hour: 0, minute: 0, second: 0, nanosecond: 0, offset: { 0, 0 }}
    t2 = %DateTime{year: 2000, month: 1, day: 1, hour: 0, minute: 1, second: 0, nanosecond: 0, offset: { 1, 0 }}
  ...
  test :diff do
    t1 = %DateTime{year: 2000, month: 1, day: 1, hour: 0, minute: 1, second: 0}
    t2 = %DateTime{year: 2000, month: 1, day: 1, hour: 0, minute: 0, second: 30}
    assert Calendar.diff(t1, t2) == 30
  end

  test :day_of_week do
    t = %DateTime{year: 2013, month: 6, day: 8}
    assert Calendar.day_of_week(t) == 6

    t = %DateTime{year: 2013, month: 6, day: 9}
    assert Calendar.day_of_week(t) == 0
  end

  test :day_of_year do
    t = %DateTime{year: 2013, month: 1, day: 1}
    assert Calendar.day_of_year(t) == 1

    t = %DateTime{year: 2013, month: 6, day: 11}
    assert Calendar.day_of_year(t) == 162
  end

  test :year do
    t = %DateTime{year: 2013}
  ...
  test :is_leap? do
    t1 = %DateTime{year: 2000}
    t2 = %DateTime{year: 2100}
...
defmodule Calendar.FormatTest do
  ...
  test "SSS" do
    t = %DateTime{nanosecond: 123000}
    assert Calendar.format(t, "SSS") == "123"

    t = %DateTime{nanosecond: 12300}
    assert Calendar.format(t, "SSS") == "012"

    t = %DateTime{nanosecond: 1230}
  ...
  test "ZZ" do
    t = %DateTime{offset: { 0, 0 }}
    assert Calendar.format(t, "ZZ") == "+00:00"

    t = %DateTime{offset: { -11, 30 }}
  ...
  test "rfc" do
    t = %DateTime{year: 2013, month: 3, day: 1, hour: 20, minute: 3, second: 15, offset: { -3, 30 }}
...
defmodule Calendar.ParseTest do
  ...
  test "rfc" do
    t1 = %DateTime{year: 2013, month: 3, day: 1, hour: 20, minute: 3, second: 15, offset: { -3, 30 }}
